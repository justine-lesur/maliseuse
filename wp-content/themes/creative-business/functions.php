...
function creative_business_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'creative-business' ), esc_url( __( 'https://demo.rarathemes.com/creative-business/', 'creative-business' ) ), esc_html__( 'Click here.', 'creative-business' ) );
